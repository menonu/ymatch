...
| **Availability** | **Provisional product target ≥ 98%** uptime (not yet a measured SLO); detection via monitoring, **not** multi-instance redundancy. Recoverable single-VM OCI deploy (backups, documented DR). |
