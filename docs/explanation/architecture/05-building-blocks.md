...
| **Notifications** | Outbound trade alerts via **Web Push + VAPID** ([ADR 0015](../adr/0015-web-push-vapid-auto-match.md), [#577](https://github.com/menonu/ymatch/issues/577)): client service worker + Settings subscribe; backend loads stored subscriptions and POSTs after match create/reopen, incoming offer, offer accepted, and chat message; safe no-op when VAPID unset (not drawn on the L3 diagram) |
