...
| **Availability** | Environment can be restored after VM or key loss; app can be redeployed without redesign. | Object Storage backups; [disaster_recovery](../disaster_recovery.md); health/status endpoints. |
