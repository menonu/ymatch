...
- **Community** (`CommunityCard`, #570): sits **next to** the Settings card on wide viewports (≥840px) and stacks below it on narrower widths. Icons only (tooltips for a11y):
  - **X** → `https://x.com/ymatchdev`
  - **Discord** → `https://discord.gg/QWcCJspb7T`
