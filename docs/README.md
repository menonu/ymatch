...
* [Architecture (arc42)](explanation/architecture/README.md): Living system architecture — goals, constraints, **C4** context/containers/components/deployment (sections 03, 05, 07), runtime scenarios, cross-cutting concerns, quality. Prefer this over older one-page notes.
