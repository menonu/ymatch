...
* [Frontend-Driven E2E Tests](how_to/e2e_tests.md): How to run the wire-contract E2E suite locally (#213) and how to dispatch the same suite on a PR branch via `workflow_dispatch` (#456).
...
* [Secret Management](explanation/secret_management.md): Operator map of where secrets live (local `.env`, GitHub, remote Terraform state vs future Vault), inventory, rotation, bootstrap, and hardening roadmap (#529 / #530).
