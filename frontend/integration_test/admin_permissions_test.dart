...
void main() {
  ...
  group('Admin & Permissions E2E', () {
    testWidgets('Admin can view users tab and see role/ban info', (
      tester,
    ) async {
      final mockUsers = [
        {
    ...
    testWidgets('Draft events show DRAFT badge on home screen', (tester) async {
      final mockClient = MockClient((request) async {
        final path = request.url.path;
    ...
    testWidgets('Merch with status and deletion info is displayed correctly', (
      tester,
    ) async {
      final mockClient = MockClient((request) async {
        final path = request.url.path;
